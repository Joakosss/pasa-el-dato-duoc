...
export function SearchBar({
  ...
  if (variant === "panel") {
    ...
    return (
      <section
        id={id}
        aria-label="Búsqueda"
        className="absolute inset-x-0 top-full z-40 border-b border-gray-200 bg-white shadow-lg sm:hidden"
      >
        <div className="mx-auto flex max-w-7xl flex-col items-stretch gap-2 px-4 py-3">
          <SearchFields idPrefix={id} autoFocus={autoFocusInput} />
        </div>
      </section>
    );
  }
  ...
  return (
    <section aria-label="Búsqueda" className="sticky top-16 z-40 border-b border-gray-200 bg-surface">
